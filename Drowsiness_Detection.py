...
def eye_aspect_ratio(eye):
	...
	# compute the euclidean distance between the two sets of vertical eye landmarks (x, y)-coordinates
...
# and a second constant for the number of consecutive frames the eye must be below the threshold to set off the alarm
EYE_AR_THRESH = 0.3
EYE_AR_CONSEC_FRAMES = 48

# initialize the frame counter
COUNTER = 0
# initialize a boolean to indicate if the alarm is going off
ALARM_ON = False
